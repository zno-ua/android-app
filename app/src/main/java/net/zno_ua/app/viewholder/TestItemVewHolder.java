    ...
    public void bind(Cursor cursor) {
        ...
        if (status == ZNOContract.Test.STATUS_IDLE) {
            ...
            if (result == ZNOContract.Test.NO_LOADED_DATA) {
                actionResId = R.drawable.vec_file_download_white_24dp;
                ...
                actionResId = R.drawable.vec_delete_white_24dp;
                description += (isEmpty(description) ? "" : ", ");
                description += buildQuestionsCount(cursor.getInt(Column.QUESTIONS_COUNT));
            } else {
                actionResId = R.drawable.vec_sync_problem_white_24dp;
            ...
            mIvActionIcon.setImageResource(R.drawable.vec_sync_white_24dp);
            mIvActionIcon.setVisibility(View.VISIBLE);
